...
public class SkierRestController {
    ...
    @GetMapping("/get")
    public List<Skier> getSkiers() {return skierService.retrieveAll();}
    @PutMapping("/update/{skier}")
    public Skier updateSkier(Skier skier){return skierService.updateSkier(skier);}

@DeleteMapping("/delete")
    public Skier deleteSkier(Long numSkier){  skierService.removeSkier(numSkier); return getSkier(numSkier);}
